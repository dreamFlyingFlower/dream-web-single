...
//
//	public static final String RESOURCE_ID = "dream-basic-resource";
//
...
//			        .antMatchers("/uaa/druid/**").denyAll().antMatchers("/uaa/**").permitAll();
//		}
//	}
//
//	/**
...
//		public void configure(HttpSecurity http) throws Exception {
//			http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED).and().authorizeRequests()
//			        .antMatchers("/consumer/l/**").denyAll().antMatchers("/consumer/my/**")
//			        .access("#oauth2.hasScope('read') and #oauth2.clientHasRole('ROLE_CONSUMER')")
