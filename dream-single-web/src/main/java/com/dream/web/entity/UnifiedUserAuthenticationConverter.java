...
/**
 * 参照 {@link DefaultUserAuthenticationConverter}
 * 
 * @author 飞花梦影
...
public class UnifiedUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Map<String, ?> convertUserAuthentication(Authentication authentication) {
		...
		if (authentication.getPrincipal() instanceof UnifiedUserDetails) {
			...
			response.put("depart_id", unifiedUserDetails.getDepartId());
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			// UnifiedUserDetails unifiedUserDetails = new
			...
			unifiedUserDetails.setDepartId((String) map.get("depart_id"));
			// unifiedUserDetails.setUserAuthorities((Map<String, List<String>>)
			// map.get("user_authorities"));
